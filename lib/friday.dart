    ...
    return Scaffold(
      ...
      body:Stack(
        ...
        children:<Widget>[
          ...
          Positioned(
            child: Text("Friday", style: GoogleFonts.oswald(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),),
            top: 40,
            left: 20,
          ),
          ...
          DraggableScrollableSheet(
            ...
            ExpansionTile(
              ...
              children: <Widget>[
                ListTile(
                  title:Text('Time : 9:30pm - 12am', style: GoogleFonts.oswald(color: Colors.lightBlue),),
                  trailing: Icon(Icons.watch_later,
                  color: Colors.lightBlue,),
                ),
                 ListTile(
            ...
            ExpansionTile(
              ...
              children: <Widget>[
                ListTile(
                  title:Text('Time : 12:30am', style: GoogleFonts.oswald(color: Colors.lightBlue),),
                  trailing: Icon(Icons.watch_later,
                  color: Colors.lightBlue,),
                ),
                 ListTile(
